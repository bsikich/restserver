...
<div id="container">
    ...
    <div id="body">
        ...
        <ul>
          <li><a href="<?php echo base_url()?>api/example/customusers">AllUsers</a> - defaulting to JSON</li>
          <li><a href="<?php echo base_url()?>api/example/customusers/format/xml">AllUsers</a> - defaulting to XML</li>
          <li><a href="<?php echo base_url()?>api/example/customusers/id/3">User #3</a> - defaulting to JSON</li>
          <li><a href="<?php echo base_url()?>api/example/customusers/id/3/format/xml">User #3</a> - defaulting to XML</li>
          <li><a href="<?php echo base_url()?>api/example/customusers/lname/smithson">User "Smithson"</a> - defaulting to JSON</li>
          <li><a href="<?php echo base_url()?>api/example/customusers/lname/smithson/format/xml">User "Smithson"</a> - defaulting to XML</li>
        </ul>
        <ol>
